 ...
 *               (unchanged in Chapter 27 - see list.h for why)
 *
 * Description:
 ...
 *  TaskState, READY, BLOCKED, priority, or the scheduler. That
 *  separation is the entire point of pulling this into its own
 *  module: kernel.c decides what a list MEANS, list.c only
 *  implements how a list WORKS. Chapter 27 needed five ready lists
 *  instead of one, and needed exactly zero changes here to get them.
 ******************************************************************************/
