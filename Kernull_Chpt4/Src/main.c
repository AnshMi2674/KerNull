...
// ═══════════════════════════════════════════════════════════════
//  Ch.4 rewrite — cooperative round-robin kernel
//  Hardware init unchanged from Stage 0. The old single while(1)
//  superloop is now three separate task functions, each doing
//  ONE PASS's worth of work per call, dispatched by kernel_start().
// ═══════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════
//  TASK FUNCTIONS — each does ONE PASS per call, then returns.
//  kernel_start() supplies the repetition, forever.
// ═══════════════════════════════════════════════════════════════
