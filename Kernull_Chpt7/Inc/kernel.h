 ...
 *
 * Description:
 *  Public interface for the RTOS kernel developed up to Chapter 7.
 *
 ...
 *  - Priority scheduling, delays and linked lists will be added in
 *    later chapters.
 ******************************************************************************/
 ...
 *
 * Chapter 7 now actively uses READY and RUNNING (previously RUNNING
 * was declared but never actually assigned anywhere -- the scheduler
 * now sets it correctly on every switch). BLOCKED is included because
 * it becomes necessary in Chapter 26.
 */
typedef enum
{
    /*
